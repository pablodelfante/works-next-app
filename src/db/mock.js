export const mock = [
    {
        ...
        image: { url: 'https://media.graphassets.com/7oiTVlNWQdDkHhW3jbNA' },
    ...
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/cd0keiuCRHat2OfC6haG' },
        tags: ['nextJs', 'pwa', 'docker', 'tailwind', 'hygraph', 'graphql', 'figma'],
        components: [],
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/H6Yw8BCvR9idWeCpPikQ' },
        tags: ['node', 'expressJs', 'webWorkers', 'ssr'],
        components: [],
    },
    {
        ...
        highlighted: false,
        githubUrl: null,
        image: { url: 'https://media.graphassets.com/KLdmTcqMSdCFp5hukJKc' },
        tags: ['figma', 'photoshoop', 'ilustrator'],
        components: [{ __typename: 'Video', videoUrl: 'https://www.youtube.com/embed/3cLymG7PwM4' }],
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/yMSoiraR5C6CoTjqSz3D' },
    ...
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/HY6PL2isS0ueD57DE04O' },
    ...
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/KenWjne7QiOrLClZutNF' },
        tags: ['expressJs', 'tailwind', 'socketIo', 'nodemon'],
        components: [],
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/MGNOst36Q2ypnxM4AKZh' },
        tags: ['php', 'mySQL', 'browserSync'],
        components: [{ __typename: 'Video', videoUrl: 'https://www.youtube.com/embed/2Uspqad9kaU' }],
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/Euua1p04SIac3egQANVJ' },
        tags: ['html', 'css', 'scss', 'javascript', 'gulp'],
        components: [{ __typename: 'Video', videoUrl: 'https://www.youtube.com/embed/zwcDITgrw-0' }],
    },
    {
        ...
        image: { url: 'https://media.graphassets.com/YcLcos57Tr2sy2w9Z9OY' },
        tags: ['html', 'javascript', 'figma', 'scss', 'node'],
        components: [
            {
                __typename: 'Markdown',
                markdown:
