            ...
            <ul className='grid grid-flow-row xl:grid-flow-col auto-cols-max | justify-between items-end gap-3'>
                ...
                <li className='flex flex-col gap-3'>
                    ...
                    <Link href='https://github.com/pablodelfante'>
                            ...
                            <svg  xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 44.13 45.88" stroke="currentColor" viewBox="0 0 389.03 123.87" className='w-16 cursor-pointer'>
