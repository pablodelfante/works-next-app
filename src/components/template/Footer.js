        ...
        <footer className="py-10">
            <ul className="grid grid-flow-row xl:grid-flow-col auto-cols-max | justify-between items-end gap-3">
                ...
                <li className="flex flex-col gap-3">
                    ...
                    <a href="https://github.com/pablodelfante" target="_blank" aria-label="Github profile">
                        <svg
                    ...
                    {/* LINKEDIN */}
                    <a href="https://www.linkedin.com/in/pablodelfante/" target="_blank" aria-label="Linkedin profile">
